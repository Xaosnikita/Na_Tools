...
namespace Test_NavalAction_Tool
{
    public partial class Form_NickMickelsonsToolbox : Form
    {
        ...
        public Form_NickMickelsonsToolbox()
        {
        ...
        {
            mouseInPanel = true;
            //MessageBox.Show("Mouse in box");
        }

        private void pictureBox_ActiveMap_MouseLeave(object sender, EventArgs e)
        {
            mouseInPanel = false;
            //MessageBox.Show("Mouse out of box");
        }

        private void pictureBox_ActiveMap_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void pictureBox_ActiveMap_MouseMove(object sender, MouseEventArgs e)
        {
            if (_pMove)
            {
                pictureBox_ActiveMap.Left = pictureBox_ActiveMap.Left + (Cursor.Position.X - _tmpX);
                pictureBox_ActiveMap.Top = pictureBox_ActiveMap.Top + (Cursor.Position.Y - _tmpY);
        ...
        private void pictureBox_ActiveMap_MouseUp(object sender, MouseEventArgs e)
        {
            _pMove = false;
        ...
        {
            MessageBox.Show("Scroll is working");
            if (mouseInPanel)
            {
                MessageBox.Show("Scroll is working");
                Size pSize = pictureBox_ActiveMap.Size;
                ...
                {
                    pictureBox_ActiveMap.Size = size;
                }
            }
